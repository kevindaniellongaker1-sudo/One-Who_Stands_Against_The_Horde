...
class FeatDef
{
    ...
    public static readonly List<FeatDef> All = new()
    {
        ...
        new("Kehon Orange Belt", "+1 grapple rolls, +2 grapple damage, and the POWER FIST: +2d4 unarmed damage at your normal attack roll, for one chi.", "Kehon"),
        new("Judo Orange Belt", "Reaction-grapple throws hurl foes 1 square further, and you gain TRIP: a roll that puts a foe on the ground 1 square back.", "Judo"),
        new("Taekwondo Orange Belt", "One extra attack OR grapple every action.", "Taekwondo"),
        new("Chidia Orange Belt", "An extra kick and punch each attack, +2 unarmed attack rolls, +1d2 unarmed damage.", "Chidia"),
